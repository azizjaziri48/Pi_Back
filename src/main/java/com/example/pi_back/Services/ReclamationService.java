...
public interface ReclamationService {
    ...
    Reclamation respondToReclamation(int idReclamation, String reponse) throws MalformedURLException;


    public String getReclamationStatus(int idReclamation);

    //  ByteArrayInputStream generatePdfReport() throws IOException;
